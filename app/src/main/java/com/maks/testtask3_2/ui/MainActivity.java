...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadPictureBySearchButton();
        loadPictureByVirtualEnterKey();
    }
    ...
    private void loadPicture() {
        String messageWhenNull = this.getString(R.string.toast_message_null);
        String messageWhenIncorrect = this.getString(R.string.toast_message_incorrect);
